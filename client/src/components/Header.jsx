...
import {Button, Dropdown, Navbar, NavbarCollapse, NavbarToggle, TextInput,Avatar, DropdownItem} from 'flowbite-react';
            ...
            {currentUser?(
                ...
                inline label={
                    ...
                    <Dropdown.Header>
                        ...
                        <span className=' text-sm font-medium truncate block'>@{currentUser.email}</span>
